class Demo {
    ...
    obj.show("A"); // String
    // obj.show(7.5); // since float datatype is not available and so it's higher datatype is double which is not available, so at this step their will be an error.
    }
